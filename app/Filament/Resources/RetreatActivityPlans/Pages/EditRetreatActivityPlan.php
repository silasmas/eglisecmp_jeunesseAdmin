...
class EditRetreatActivityPlan extends EditRecord
{
    ...
    protected function afterSave(): void
    {
        ...
        Notification::make()
            ...
            ->body('Une activite avec la meme session, titre, type, debut et fin existe deja. La modification a ete enregistree.')
            ->warning()
            ->send();
    }
}
